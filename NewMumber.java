...
public class NewMumber extends javax.swing.JFrame {
    ...
    public NewMumber() {
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("select max(id) from mumber");
            while (rs.next()) {
                id = rs.getInt(1);
                id = id + 1;
    ...
    private void initComponents() {
        ...
        jLabel11.setText("Aathar Number (unique ID)");
        ...
        jLabel13.setText("Amount to Pay/momth");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            System.out.println("line 0");
             Class.forName("com.mysql.jdbc.Driver");
            Connection  con=DriverManager.getConnection("jdbc:mysql://localhost:3306/gms","root","" );
            PreparedStatement ps = con.prepareStatement("insert into mumber values (?,?,?,?,?,?,?,?,?,?,?)");
            ps.setString(1, id);
            ps.setString(2, name);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewMumber.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
