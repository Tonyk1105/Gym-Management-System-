...
public class ListOfMembers extends javax.swing.JFrame {
    ...
    public ListOfMembers() {
        ...
        try{
         Connection con=conncectionProvider.getCon();
            ...
            ResultSet rs=st.executeQuery("select * from mumber");
            while(rs.next()){
    ...
    private void initComponents() {
        ...
        jButton1.setBackground(new java.awt.Color(5, 118, 221));
        ...
        jLabel1.setText("List Of Mumber");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mumber ID", "Name", "Mobile Number", "Email", "Grnder", "Father Name", "Mother Name", "Gym Time", "AadharNumber", "Age", "Amount"
            }
        ));
